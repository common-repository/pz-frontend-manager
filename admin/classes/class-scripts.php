		...
		public function pzfm_styles_scripts() {
		    ...
		    if( 
				...
				$translation   = array(
					...
					'confirmActivate'   			=> apply_filters( 'pzfm_activate_confirmation', __( 'Are you sure you want to activate selected items?', 'pz-frontend-manager' ) ),
					'confirmDeactivate'   			=> apply_filters( 'pzfm_deactivate_confirmation', __( 'Are you sure you want to deactivate selected items?', 'pz-frontend-manager' ) ),
					...
					'security' 						=> wp_create_nonce('pzAjax-nonce')
				);
